...
require (
	...
	github.com/hedzr/store/codecs/hcl v1.3.60 // indirect
	github.com/hedzr/store/codecs/hjson v1.3.60 // indirect
	github.com/hedzr/store/codecs/json v1.3.60 // indirect
	github.com/hedzr/store/codecs/nestext v1.3.60 // indirect
	github.com/hedzr/store/codecs/toml v1.3.60 // indirect
	github.com/hedzr/store/codecs/yaml v1.3.60 // indirect
